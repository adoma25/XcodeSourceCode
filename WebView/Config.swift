...
var app_admin_email = "app_admin@example.org"


// *** Your Website ***

// 4. Enter your website details here:
var host = "bursadeseuri.ro" //Set your domain host without http:// or https:// prefixes and without any subdomain like "www."
var webviewurl = "https://bursadeseuri.ro" //Set your full web app/website URL including http:// or https:// prefix and including subdomains if they are in your URL, like "www.", for example
...
var preventoverscroll = false //Set to "false" to enable pull to refresh in your app.
...
var pulltorefresh = true //Pull to refresh ENABLED

var pulltorefresh_loadingsigncolour_lightmode = #colorLiteral(red: 0.294, green: 0.671, blue: 0.016, alpha: 1) //Brand green #4BAB04
...
var pulltorefresh_loadingsigncolour_darkmode = #colorLiteral(red: 0.294, green: 0.671, blue: 0.016, alpha: 1) //Brand green #4BAB04
...
var statusBarBackgroundColor = #colorLiteral(red: 0.294, green: 0.671, blue: 0.016, alpha: 1) //Brand green #4BAB04
...
var darkmodeBottombarBackgroundColor = #colorLiteral(red: 0.11, green: 0.11, blue: 0.118, alpha: 1) //Dark mode bottom bar

// Navigation Toolbar Configuration (Back, Forward, Home, Refresh buttons)
var enableNavigationToolbar = true //Set to "true" to show navigation bar at bottom
var navigationToolbarHeight: CGFloat = 50 //Height of navigation toolbar
var navigationToolbarBackgroundColor = #colorLiteral(red: 0.294, green: 0.671, blue: 0.016, alpha: 1) //Brand green #4BAB04
var navigationToolbarTintColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1) //White icons
var darkModeNavigationToolbarBackgroundColor = #colorLiteral(red: 0.11, green: 0.11, blue: 0.118, alpha: 1) //Dark mode background
var darkModeNavigationToolbarTintColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1) //White icons
...
var loadingIndicatorColor = #colorLiteral(red: 0.294, green: 0.671, blue: 0.016, alpha: 1) //Brand green #4BAB04
